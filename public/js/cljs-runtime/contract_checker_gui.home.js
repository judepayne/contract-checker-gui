...
var G__49037 = new cljs.core.Keyword(null,"type","type",1174270348);
var fexpr__49036 = cljs.core.ex_data(e);
return (fexpr__49036.cljs$core$IFn$_invoke$arity$1 ? fexpr__49036.cljs$core$IFn$_invoke$arity$1(G__49037) : fexpr__49036.call(null,G__49037));
})),(function (p__49038){
...
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49039__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49039__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"producer-area",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Paste the producer schema here",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"producer-schema","producer-schema",-195762973).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"rows","rows",850049680),(12),new cljs.core.Keyword(null,"cols","cols",-1914801295),(50),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49041_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"producer-schema","producer-schema",-195762973),p1__49041_SHARP_.target.value);
})], null)], null);
});
contract_checker_gui.home.consumer_area = (function contract_checker_gui$home$consumer_area(state){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"consumer-area",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Paste the consumer schema here",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"consumer-schema","consumer-schema",974955272).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"rows","rows",850049680),(12),new cljs.core.Keyword(null,"cols","cols",-1914801295),(50),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49042_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"consumer-schema","consumer-schema",974955272),p1__49042_SHARP_.target.value);
})], null)], null);
});
...
contract_checker_gui.home.display_errors = (function contract_checker_gui$home$display_errors(state){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"errors","errors",-908790718),cljs.core.deref(state)], null);
});
contract_checker_gui.home.home_page = (function contract_checker_gui$home$home_page(){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.page","div.page",1917984906),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.main","div.main",-117780813),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [contract_checker_gui.home.producer_area,contract_checker_gui.home.local_state], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [contract_checker_gui.home.consumer_area,contract_checker_gui.home.local_state], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [contract_checker_gui.home.compare_button], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [contract_checker_gui.home.display_errors,contract_checker_gui.home.local_state], null)], null)], null);
});
